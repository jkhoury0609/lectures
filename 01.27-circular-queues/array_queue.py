class Queue:
    ...
    def __init__(self):
        ...
        #       ensure that indices range between 0 and size - 1. Since we do
        #       not actually care about the indices, we'll allow them to range
        #       between some arbitrary front and some arbitrary back:
...
def enqueue(queue, value):
    ...
    #       able to "wrap around" to fill this space. Three possibilities exist:
    ...
    #       ...elements will need to be shifted in the act of "unwrapping" them
    #       while increasing capacity, but copying them already requires us to
    #       iterate over the entire array anyways, so it's not actually any
    #       less efficient.
    #
    ...
    # Else, do:
    #     Increment back and mod it by the capacity.
    #
...
def dequeue(queue):
    ...
    # Else, do:
    #     Increment front and mod it by the capacity.
    pass
